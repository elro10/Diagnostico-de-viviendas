    ...
    <main className="min-h-screen bg-white text-slate-800">
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-5 py-14 sm:px-6 md:px-8 lg:grid-cols-2 lg:items-center lg:gap-16 lg:py-24">
          <div>
            ...
            <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600 sm:text-lg">
              Inspeccionamos viviendas, casas y departamentos para detectar humedad, fugas, fallas
              eléctricas básicas, desniveles y otros problemas que muchas veces no se ven a simple
              vista.
            </p>
            <p className="mt-4 max-w-2xl text-base leading-7 text-slate-600">
              Un informe técnico a tiempo puede ayudarte a negociar mejor, evitar gastos inesperados
              y reducir futuros reclamos entre partes.
            </p>
              ...
              <div className="rounded-[1.5rem] bg-slate-950 p-5 text-slate-100 sm:p-6">
                ...
                <div className="mt-6 rounded-2xl border border-slate-800 bg-slate-900/70 p-4">
                  ...
                  <p className="mt-2 text-sm leading-6 text-slate-300">
                    compra, alquiler, cierre de contrato, venta y verificación previa para reducir
                    riesgos y reclamos.
                  </p>
                </div>
                <div className="mt-6 rounded-2xl border border-dashed border-slate-700 bg-slate-900/40 p-4">
                  <p className="text-sm font-semibold text-white">Inspección en acción</p>
                  <div className="relative mt-3 h-48 w-full overflow-hidden rounded-xl">
                    <Image
                      src="https://res.cloudinary.com/dgfp1qcnq/image/upload/f_auto/v1778783862/IMG_8562_w5bfxi.heic"
                      alt="Profesional midiendo una grieta con herramientas de precisión"
                      fill
                  ...
                  <p className="mt-3 text-xs text-slate-400">
                    Medición de grietas y desniveles con tecnología láser.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="mx-auto max-w-7xl px-5 sm:px-6 md:px-8">
          <div className="grid gap-4 md:grid-cols-3">
            {trustPoints.map((point) => (
              <div
                key={point}
                className="rounded-3xl border border-slate-200 bg-slate-50 px-5 py-4 text-center shadow-sm"
              >
      ...
      <section className="bg-slate-50 py-16 sm:py-20">
        <div className="mx-auto max-w-7xl px-5 sm:px-6 md:px-8">
          ...
          <div className="mt-10 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
            {audiences.map((item) => {
              let Icon;
              if (item.includes('Comprador')) Icon = User;
              else if (item.includes('Inquilino')) Icon = Home;
              else if (item.includes('Propietario')) Icon = FileCheck;
              else if (item.includes('Vendedor')) Icon = Shield;
              else Icon = Building;
              ...
              return (
                ...
                >
                  <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-2xl bg-sky-100 text-sky-700">
                    <Icon size={20} />
                  </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {services.map((service) => {
                const iconMap: Record<string, any> = {
                  Humedad: Droplets,
                  'Nivelación y desniveles': Ruler,
                  'Instalación eléctrica básica': Zap,
                  'Pérdidas o fugas': Wrench,
                  'Estado general de muros, cielorrasos, pisos y aberturas': Home,
                  'Artefactos o enchufes': Plug,
                  'Observaciones constructivas y funcionales': Eye,
                };
                const Icon = iconMap[service] || Eye;
                return (
                  <div
                    key={service}
      ...
      <section className="max-w-5xl mx-auto px-6 py-20">
        ...
        <p className="mb-8 text-slate-600 leading-7">
          Muchas viviendas presentan problemas que no son visibles durante una visita rápida. Una
          inspección técnica permite identificar riesgos y costos ocultos antes de tomar una
        ...
        <p className="mt-8 text-slate-600 leading-7">
          ...
          profesionales como cámara termográfica, detector de fugas, medidor de humedad y nivel
          láser.
        </p>
      </section>
          ...
          <div className="grid gap-8 lg:grid-cols-2">
            <div className="rounded-[2rem] border border-slate-200 bg-white p-8 shadow-sm">
              ...
              <p className="mt-4 text-base leading-7 text-slate-600">
                Combinamos inspección visual profesional con instrumentos de medición para obtener
                información más precisa y útil al momento de evaluar un inmueble.
              </p>

              {/* Grilla de imágenes de herramientas */}
              <div className="mt-8 grid gap-6 sm:grid-cols-2">
                {/* Medidor de humedad */}
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  <div className="relative h-32 w-full overflow-hidden rounded-xl">
                    <Image
                      src="https://res.cloudinary.com/dgfp1qcnq/image/upload/v1778802868/imagen_2026-05-14_205429369_mjsijd.png"
                      alt="Medidor de humedad en funcionamiento"
                      fill
                      className="object-contain"
                      sizes="(max-width: 768px) 100vw, 50vw"
                    />
                  </div>
                  <p className="mt-3 text-center text-sm font-medium text-slate-700">Medidor de humedad</p>
                </div>
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  <div className="relative h-32 w-full overflow-hidden rounded-xl">
                    <Image
                      src="https://res.cloudinary.com/dgfp1qcnq/image/upload/v1778802746/9f37a037-e054-4039-b2a7-708d45aac605.png"
                      alt="Detector de materiales"
                      fill
                      className="object-contain"
                      sizes="(max-width: 768px) 100vw, 50vw"
                    />
            ...
            <div className="rounded-[2rem] border border-slate-200 bg-white p-8 shadow-sm">
              ...
              <p className="mt-4 text-base leading-7 text-slate-600">
                Cada inspección finaliza con una entrega ordenada y fácil de entender para que el
                cliente pueda tomar decisiones con mayor seguridad.
              </p>
              ...
              <div className="mt-6 rounded-3xl border border-dashed border-slate-300 bg-slate-50 p-5">
                <p className="text-sm font-semibold text-slate-900">
                  Ejemplo de diagnóstico con cámara termográfica
                </p>
                <div className="relative mt-3 h-48 w-full overflow-hidden rounded-xl">
                  <Image
                    src="https://res.cloudinary.com/dgfp1qcnq/image/upload/f_auto/v1778800791/WhatsApp_Image_2026-05-14_at_20.19.22_nbdhc5.jpg"
                    alt="Imagen termográfica mostrando pérdida de calor o humedad"
                    fill
                    className="object-cover"
                    sizes="(max-width: 768px) 100vw, 50vw"
                  />
                ...
                <p className="mt-3 text-xs text-slate-500">
                  Detección de anomalías no visibles a simple vista.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
                  ...
                  <div key={member.name} className="rounded-3xl border border-slate-200 bg-slate-50 p-5">
                    <div className="relative mx-auto mb-4 h-24 w-24 overflow-hidden rounded-full bg-slate-200">
                      {member.img ? (
                        ...
                        <div className="flex h-full w-full items-center justify-center bg-slate-300 text-xs text-slate-600">
                          Foto
                        </div>
                      )}
                    </div>
                    <p className="text-center text-base font-semibold text-slate-900">{member.name}</p>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="rounded-[2rem] border border-slate-200 bg-slate-900 p-8 text-white shadow-sm">
              ...
              <p className="mt-4 text-base leading-7 text-slate-300">
                Realizamos inspecciones de viviendas, casas y departamentos en Córdoba Capital y
                sectores cercanos según disponibilidad y tipo de inmueble.
              </p>
      ...
      <section className="bg-slate-50 py-16 sm:py-20">
        <div className="mx-auto max-w-7xl px-5 sm:px-6 md:px-8">
          <SectionTitle eyebrow="Cómo funciona" title="Un proceso claro, breve y fácil de coordinar." />
        ...
        <div className="mx-auto max-w-7xl px-5 sm:px-6 md:px-8">
          <div className="grid gap-8 lg:grid-cols-2">
            ...
            <div className="rounded-[2rem] border border-slate-200 bg-white p-8 shadow-sm">
              ...
              <p className="mt-4 text-base leading-7 text-slate-600">
                La inspección no reemplaza ensayos destructivos, certificaciones específicas de
                instalaciones ni pericias judiciales. El objetivo es brindar una evaluación técnica
                visible, instrumental y funcional del inmueble al momento de la visita.
              </p>
              <div className="mt-6 rounded-3xl border border-slate-200 bg-slate-50 p-5">
                <p className="text-sm leading-6 text-slate-700">
                  Esta aclaración mejora la credibilidad del servicio, ordena expectativas y reduce
          ...
          <div className="overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-sm">
            <div className="grid lg:grid-cols-[0.95fr_1.05fr]">
              <div className="bg-slate-900 p-8 text-white sm:p-10">
                ...
                <h2 className="font-display mt-3 text-3xl font-bold tracking-tight">
                  Pedí una evaluación técnica de la vivienda
                </h2>
                <p className="mt-4 text-base leading-7 text-slate-300">
                  Completá el formulario con los datos básicos del inmueble y del servicio que
                  necesitás. Si preferís, también podés hacer una consulta inicial por WhatsApp.
                </p>
          ...
          <div className="grid gap-10 md:grid-cols-3">
            <div>
              ...
              <p className="mt-4 text-sm leading-7 text-slate-400">
                Inspección preventiva de viviendas en Córdoba Capital y zonas aledañas. Diagnóstico
                técnico profesional para comprar, alquilar, entregar o recibir una propiedad con
                mayor seguridad.
              </p>
            </div>
            <div>
